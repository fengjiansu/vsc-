...
#define Max 4396
#define N 19
void Prim(float c[19][19], int (*number)[2])
{
...
int main()
{
    ...
    int x[] =
        {
            26, 5, 8, 10, 13, 17, 20, 25, 31, 35, 36, 41, 45, 28, 24,12,20,37,22,26,23};
    int y[] = {31, 33, 9, 24, 34, 23, 10, 47, 18, 42, 25, 31, 38, 32, 30,17,22,25,44,44,46};
