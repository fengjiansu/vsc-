...
void printUnreachData(const unsigned char* data, int len, int cols) {
	int i;
	for (i = 0; i < len; ++i) {
		if (i % cols == 0) LOG("| %02x ", data[i]);
		else LOG("%02x ", data[i]);
...
void printIcmp(struct icmp* icmp, int len) {
	...
	WARNING("type:             %d", icmp->icmp_type);
	if(icmp->icmp_type==3)
	{
		WARNING("Destination Unreachable\n");
		
	}
	WARNING("code:             %d", icmp->icmp_code);
	if(icmp->icmp_type==3)
	{
		switch(icmp->icmp_code)
		{
			case 0:WARNING("Destination network unreachable\n");break;
			case 1:WARNING("Destination host unreachable\n");break;
			case 2:WARNING("Destination protocol unreachable\n");break;
			case 3:WARNING("Destination port unreachable\n");break;
			case 4:WARNING("Fragmentation required, and DF flag set\n");break;
			case 5:WARNING("Source route failed\n");break;
			case 6:WARNING("Destination network unknown\n");break;
			case 7:WARNING("Destination host unknown\n");break;
			case 8:WARNING("Source host isolated\n");break;
			case 9:WARNING("Network administratively prohibited\n");break;
			case 10:WARNING("Host administratively prohibited\n");break;
			case 11:WARNING("Network unreachable for ToS\n");break;
			case 12:WARNING("Host unreachable for ToS\n");break;
			case 13:WARNING("Communication administratively prohibited\n");break;
			case 14:WARNING("Host Precedence Violation\n");break;
			case 15:WARNING("Precedence cutoff in effect\n");break;
		}
	}
